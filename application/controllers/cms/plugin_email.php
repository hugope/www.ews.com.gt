<?php
/**
 * @name Administrador del plugin email
 * 
 * 
...
class Plugin_email extends PL_Controller {
	...
	function __construct(){
		...
		$this->plugin_action_table			= 'PLUGIN_EMAIL'; //Nombre de la tabla
		$this->plugin_button_create			= "Crear Nuevo Email"; //Titulo del botón para crear nuevo valor
		$this->plugin_button_cancel			= "Cancelar"; //Boton de cancelar
		$this->plugin_button_update			= "Guardar Cambios"; //Guardar cambios
		$this->plugin_button_delete			= "Eliminar"; //Texto del botón para eliminar un valor
		$this->plugin_page_title			= "Emails"; //Título del plugin
		$this->plugin_page_create			= "Crear Nuevo Email"; //Título de la pagina para crear un nuevo valor
